...
export default function LoginPsy() {
  ...
  const handleLogin = async () => {
    try {
      const response = await api.post("/psychologists/login", {
        email,
        password: senha,
      });
      ...
      await AsyncStorage.setItem("psyId", id.toString());
  
      Alert.alert("Sucesso", "Login realizado com sucesso!");
      router.push("../homePsy/HomePsy");
    } catch (error) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.text}>
          ...
          <Text style={styles.registerText} onPress={() => router.push("../register/RegisterPsicologo")}>
            Cadastre-se
          </Text>
        </Text>
      </View>
